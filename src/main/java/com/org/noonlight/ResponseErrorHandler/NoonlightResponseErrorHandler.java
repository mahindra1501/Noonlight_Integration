package com.org.noonlight.ResponseErrorHandler;
...
public class NoonlightResponseErrorHandler implements ResponseErrorHandler {

	private static final Log logger = LogFactory.getLog(NoonlightResponseErrorHandler.class);
